// FunctionalTest.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CFunctionalTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CFunctionalTestApp construction

CFunctionalTestApp::CFunctionalTestApp()
{
...
// The one and only CFunctionalTestApp object

CFunctionalTestApp theApp;


// CFunctionalTestApp initialization

BOOL CFunctionalTestApp::InitInstance()
{
