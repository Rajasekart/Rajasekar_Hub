// ePower_MFG.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CePower_MFGApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CePower_MFGApp construction

CePower_MFGApp::CePower_MFGApp()
{
...
// The one and only CePower_MFGApp object

CePower_MFGApp theApp;


// CePower_MFGApp initialization

BOOL CePower_MFGApp::InitInstance()
{
