...
public:
	...
	CByteArray		m_byInpVolFreqEdit;
	CStringArray	m_cszOrgOutletVolt;
	CStringArray	m_cszOrgOutletFreq;
...
class CMyListCtrlR : public CListCtrl
{
public:
...
// Implementation
	...
	// Creates and displays the in place edit control
	CMyEditR* ShowMyEdit(int iRowIndex, int iColumnIndex, CString& rstrCurSelection);
